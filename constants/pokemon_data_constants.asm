...
NUM_SWAMPMON EQU 5 ; data/wild/*_swamp.asm table size
NUM_DARKGRASSMON EQU 7 ; data/wild/*_darkgrass.asm table size

GRASS_WILDDATA_LENGTH EQU 2 + (1 + NUM_GRASSMON * 2) * 3
WATER_WILDDATA_LENGTH EQU 2 + (1 + NUM_WATERMON * 2) * 1
SWAMP_WILDDATA_LENGTH EQU (NUM_SWAMPMON * 2 + 1) * 1 + 2
DARKGRASS_WILDDATA_LENGTH EQU 2 + (1 + NUM_DARKGRASSMON * 2) * 3
